...
export function TheMechanism() {
  ...
  return (
    <section id="mecanismo" className="relative border-t border-[color:var(--amber)]/15 py-24 md:py-32">
      <div className="mx-auto max-w-7xl px-6">
        <div className="mb-16 grid gap-8 md:grid-cols-[1fr_1.2fr] md:items-end">
          <div className="space-y-6">
            <SectionLabel index="03" label="THE MECHANISM" />
            <SectionTitle>
...
export function TheFilter() {
  ...
  return (
    <section id="perfil" className="relative border-t border-[color:var(--amber)]/15 py-24 md:py-32">
      <div className="mx-auto max-w-7xl px-6">
        <div className="mb-12 max-w-3xl space-y-6">
          <SectionLabel index="05" label="THE FILTER" />
          <SectionTitle>
    ...
    <section id="cta" className="relative border-t border-[color:var(--amber)]/15 py-24 md:py-32">
      <div className="mx-auto max-w-5xl px-6 text-center">
        ...
        <div className="mt-10 flex flex-col items-center gap-4">
          <a
            href="https://wa.me/573000000000?text=Hola%20Punto%20T%C3%A1ctico%2C%20quiero%20iniciar%20mi%20tr%C3%A1mite."
            target="_blank"
        ...
        <div className="grid gap-10 md:grid-cols-[1.4fr_1fr_1fr]">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 font-mono-tech text-[11px] text-muted-foreground">
              <li><a href="#shift" className="hover:text-amber transition">Catálogo</a></li>
              <li><a href="#mecanismo" className="hover:text-amber transition">Protocolo</a></li>
              <li><a href="#proceso" className="hover:text-amber transition">Proceso</a></li>
              <li><a href="#perfil" className="hover:text-amber transition">Perfil operativo</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 font-mono-tech text-[11px] text-muted-foreground">
              <li>
                <a href="https://wa.me/573000000000" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 hover:text-amber transition">
              ...
              <li><a href="#privacidad" className="hover:text-amber transition">Política de privacidad</a></li>
              <li><a href="#terminos" className="hover:text-amber transition">Términos y condiciones</a></li>
            </ul>
          </div>
        </div>
